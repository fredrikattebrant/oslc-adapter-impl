...
public class ServiceProviderCatalogService
{
    ...
    public ServiceProviderCatalog getServiceProviderCatalog()
    {
        ...
        if (catalog != null) {
        	...
        	httpServletResponse.addHeader(Bug2adapterConstants.HDR_OSLC_VERSION,"2.0");
        	return catalog;
        }
    ...
    public void getHtmlServiceProvider(@PathParam("serviceProviderId") final String serviceProviderId)
    {
    	...
    	if (catalog !=null )
    	{
	        ...
	        RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/demo/bug2adapter/serviceProviderCatalog_html.jsp");
    		try {
