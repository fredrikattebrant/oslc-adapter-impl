...
@OslcNamespace(Bug2adapterConstants.FOAF_NAMSPACE)
@OslcName(Bug2adapterConstants.PERSON) 
@OslcResourceShape(title = "Person Resource Shape", describes = Bug2adapterConstants.TYPE_PERSON)
public class Person
...
public String toHtml()
{
   	...
   	@OslcName("name")
   	@OslcPropertyDefinition(Bug2adapterConstants.FOAF_NAMSPACE + "name")
    ...
    public String getName()
    {
   	...
   	@OslcName("givenName")
   	@OslcPropertyDefinition(Bug2adapterConstants.FOAF_NAMSPACE + "givenName")
    ...
    public String getGivenName()
    {
   	...
   	@OslcName("familyName")
   	@OslcPropertyDefinition(Bug2adapterConstants.FOAF_NAMSPACE + "familyName")
