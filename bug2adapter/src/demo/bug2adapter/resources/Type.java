...
@OslcNamespace(Bug2adapterConstants.DUBLIN_CORE_NAMSPACE)
@OslcName(Bug2adapterConstants.TYPE) 
@OslcResourceShape(title = "Type Resource Shape", describes = Bug2adapterConstants.TYPE_TYPE)
public class Type
