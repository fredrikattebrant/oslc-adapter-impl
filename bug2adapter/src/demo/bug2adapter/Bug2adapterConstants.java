...
public interface Bug2adapterConstants
{
	// Start of user code user constants
	// End of user code

		public static String BUG2_DOMAIN = "http://www.bugzilla.org/rdf#";
public static String BUG2_NAMSPACE = "http://www.bugzilla.org/rdf#";
public static String BUG2_NAMSPACE_PREFIX = "bug2";
...
public static String RDF_NAMSPACE_PREFIX = "rdf";
	    ...
	    public static String BUG2CHANGEREQUEST = "bug2ChangeRequest";
public static String PATH_BUG2CHANGEREQUEST = "bug2ChangeRequest";
public static String TYPE_BUG2CHANGEREQUEST = BUG2_NAMSPACE + "Bug2ChangeRequest";
